interface Bill {
  ...
  // DOM Elements
  const billForm = document.getElementById('billForm') as HTMLFormElement;
  const billList = document.getElementById('billList') as HTMLUListElement;
  ...
  billForm.addEventListener('submit', e => {
    ...
    const biller = (document.getElementById('biller') as HTMLInputElement).value;
    const amount = parseFloat((document.getElementById('amount') as HTMLInputElement).value);
    const dueDate = (document.getElementById('dueDate') as HTMLInputElement).value;
  
    if (!month || !biller || isNaN(amount) || !dueDate) return;
